<div class="modal-dialog" role="document" style="width: 55%;">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\HR\Http\Controllers\NoticeBoardController@store'), 'method' =>
    'post', 'id' => 'notice_form' ])
    !!}
    ...
    <div class="modal-body">
      ...
      <div class="col-md-12">
        <div class="form-group">
          ...
          {!! Form::text('short_description', null, ['class' => 'form-control short', 'id' =>
      ...
      <div class="col-xs-12">
        <div class="form-group">
          ...
          {!! Form::textarea('notice_details', '', ['class' => 'form-control','placeholder' =>
      ...
      <div class="col-md-12">
        <div class="row">
          ...
          <div class="col-md-3">
            {!! Form::select('status', ['published'=> 'Published', 'unpublished' => 'Unpublished'], null, ['class' => 'form-control', 'placeholder' => __('lang_v1.please_select')]) !!}
          </div>
        </div>
      </div>
