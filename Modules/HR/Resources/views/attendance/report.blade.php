...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(['url' => action('\Modules\HR\Http\Controllers\AttendanceController@getAttendanceReport'),
            'method' => 'get']) !!}
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" name="date" id="date" class="form-control" value="" data-format="dd-mm-yyyy"
                            autocomplete="false">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    <label for="field-1">@lang('hr::lang.department') <span class="required">*</span></label>
                                ...
                                <table class="table table-bordered cart-buttons" width="100%">
                                    ...
                                    <tbody style="display: none">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$employee[$key]->first_name}} {{$employee[$key]->last_name}} 
                                            </td>
