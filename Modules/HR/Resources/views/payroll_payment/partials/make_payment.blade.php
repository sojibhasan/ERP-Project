                ...
                <div class="wrap-fpanel">
                    <div class="box" data-collapsed="0">
                        <div class="box-header with-border bg-primary-dark">
                            <h3 class="box-title">@lang('hr::lang.make_payment')</h3>
                        </div>
                            ...
                            <div class="panel_controls">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text"
                                                value="{{($salary->total_payable + $salary->total_deduction)}}"
                                                class="form-control" disabled>
                                        </div>
                                        <div class="col-md-3">
                                        <label class=""
                                            style="text-align: right">@lang('hr::lang.deduction'): </label>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="text"
                                            ...
                                            @foreach($salaryDeductionList as $deduction)
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="{{$deduction->id}}"
                                                            class="form-control key deduction input_number" id="{{'earn'.$deduction->id }}"
                                                            value="@if(!empty($deduction->component_amount)) {{$deduction->component_amount}} @endif">

                                                        <input type="hidden" value="{{$deduction->type}}"
                                                            id="{{'type'.$deduction->id }}">
                                                        <input type="hidden" value="{{$deduction->total_payable}}"
                                                            id="{{'pay'.$deduction->id }}">
                                                        <input type="hidden" value="{{$deduction->cost_company}}"
                                                            id="{{'cost'.$deduction->id }}">
                                                        <input type="hidden" value="{{$deduction->flag}}"
                                                            id="{{'flag'.$deduction->id }}">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <label class="">@lang('hr::lang.net_salary'): </label>
                                            <input type="text"
                                                value=" {{ @number_format($salary->total_payable) }}"
                                                class="form-control input_number" disabled>
                                        </div>
                                    </div>
                                </div>
                                @else
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="text"
                                                value=" {{ @number_format($salary->hourly_salary) }}"
                                                class="form-control" disabled>
                                        </div>
                                        <div class="col-md-3">
                                ...
                                @if(!empty($award))
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        @foreach($award as $item )
                                            ...
                                            <div class="col-md-3">
                                                <input type="text"
                                                    value=" {{@number_format($item->award_amount)}}"
                                                    class="form-control input_number" disabled>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <label class="">@lang('hr::lang.fine_deduction'): </label>
                                                <input type="text" value="@if(!empty($payroll)) {{@number_format($payroll->fine_deduction)}} @endif"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <label class="">@lang('hr::lang.payment_amount'): </label>
                                                <input type="text" value="@if(!empty($payroll)) {{$payroll->net_payment}} @else {{$totalPayable}} @endif"
                               ...
                               <!-- Statutory Payment -->
                                    ...
                                    @if(count($statutoryPaymentsList))
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="{{$statutory->id }}"
                                                    class="form-control key statutory"
                                                    id="{{'earn'.$statutory->id }}"
                                                    value="@if(!empty($deduction->component_amount)) {{$deduction->component_amount }} @endif">

                                                <input type="hidden" value="{{$statutory->type}}"
                                                    id="{{'type'.$statutory->id }}">
                                                <input type="hidden" value="{{$statutory->total_payable}}"
                                                    id="{{'pay'.$statutory->id }}">
                                                <input type="hidden" value="{{$statutory->cost_company}}"
                                                    id="{{'cost'.$statutory->id }}">
                                                <input type="hidden" value="{{$statutory->flag}}"
                                                    id="{{'flag'.$statutory->id }}">
                                                <input type="hidden" value="{{$statutory->value_type}}"
                                                    id="{{'valueType'.$statutory->id }}">
                                                <input type="hidden" name="statutory[]"
                                                    value="{{$statutory->id }}">
                                            </div>
                                        </div>
                                        @endforeach
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="payment_method">
                                                    ...
                                                    <option value="@lang('hr::lang.cash')"
                                                        @if(!empty($payroll)) {{ $payroll->payment_method == __('cash')? 'selected':''}} @endif>
                                                        @lang('hr::lang.cash')</option>
                                                    <option value="@lang('hr::lang.check')"
                                                        @if(!empty($payroll)) {{ $payroll->payment_method == __('check')? 'selected':''}} @endif>
                                                        @lang('hr::lang.check')</option>
                                                    <option value="@lang('hr::lang.electronic_transfer')"
                                                        @if(!empty($payroll)) {{ $payroll->payment_method == __('electronic_transfer')? 'selected':''}} @endif>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" value="@if(!empty($payroll)) {{$payroll->note}} @endif"
                                ...
                                <input type="hidden" name="payroll_id"
                                    value="@if(!empty($payroll->id)) {{($payroll->id)}} @endif">
                            </div>
