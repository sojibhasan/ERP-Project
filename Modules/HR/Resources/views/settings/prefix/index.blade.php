<div class="pos-tab-content @if(session('status.tab') == 'prefix') active @endif">
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-4">
                    ...
                    {!! Form::text('employee_prefix', !empty($prefixes->employee_prefix) ? $prefixes->employee_prefix : null , ['class'
                    =>
                ...
                <div class="col-md-4">
                    ...
                    {!! Form::text('employee_starting_number', !empty($prefixes->employee_starting_number) ? $prefixes->employee_starting_number :
                    null , ['class' =>
