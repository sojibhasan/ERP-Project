<div class="pos-tab-content @if(session('status.tab') == 'employment_status') active @endif">
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered" id="employment_status_table"
                            style="width: 100%;">
                            <thead>
                                <tr>
