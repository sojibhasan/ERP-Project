...
class ProductionController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('manufacturing::production.edit')->with(compact('by_products', 'production_purchase', 'production_sell', 'business_locations', 'recipe_dropdown', 'ingredients', 'business_details', 'pos_settings', 'sub_units', 'quantity', 'quantity_wasted', 'actual_quantity', 'recipe', 'unit_name', 'sub_unit_id', 'total_production_cost', 'manufacturing_settings'));
    }
