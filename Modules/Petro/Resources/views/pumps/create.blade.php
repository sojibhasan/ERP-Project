<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('\Modules\Petro\Http\Controllers\PumpController@store'), 'method' => 'post',
        'id' =>
        'add_pumps_form' ]) !!}
        ...
        <div class="modal-body">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('bulk_sale_meter', __( 'petro::lang.bulk_sale_meter' ) . ':*') !!} @if(!empty($help_explanations['bulk_sale_meter'])) @show_tooltip($help_explanations['bulk_sale_meter']) @endif
