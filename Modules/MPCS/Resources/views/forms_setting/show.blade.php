<div class="modal-dialog" role="document" style="width: 65%;">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang('mpcs::lang.form_name'): {{$form_values->form_name}} &emsp;
                @lang('mpcs::lang.date'): {{$form_values->date}} &emsp; @lang('mpcs::lang.edited_by'):
                {{$form_values->edited_by}}</h4>
        </div>
        @php
        ...
        <div class="modal-body">
                        ...
                        <tr style="background: gainsboro;">
                            ...
                            <td>
                                <input type="text" name="" readonly
                                    value="{{!empty($sub_cat['amount']) ? $sub_cat['amount'] : 0.00}}"
                                    class="form-control" style="width: 100%;">
                            </td>
                            @endforeach
                        </tr>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    {!! Form::text('F21C_form_sn', !empty($form_data)? $form_data['F21C_form_sn'] : null, ['class' => 'form-control', 'id' => 'F21C_form_sn',
                    'required', 'placeholder' => __( 'mpcs::lang.form_starting_number' ) ]); !!}
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    {!! Form::text('F21C_form_tdate',  !empty($form_data)? $form_data['F21C_form_tdate'] : null, ['class' => 'form-control', 'id' => 'F21C_setting_tdate',
                    'readonly', 'required', 'placeholder' => __( 'lang_v1.transaction_date' ) ]); !!}
                </div>
            </div>
            <div class="clearfix"></div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('F21C_first_day_after_stock_taking', 1, !empty($form_data)? $form_data['F21C_first_day_after_stock_taking'] : false, ['class' => 'input-icheck', 'id' => 'first_day_after_stock_taking']); !!}
                                @lang('mpcs::lang.first_day_after_stock_taking')
                            </label>
                        </div>
                        <div class="checkbox">
                            <label style="float:left;">
                                {!! Form::checkbox('F21C_first_day_of_next_month', 1, !empty($form_data)? $form_data['F21C_first_day_of_next_month'] : false, ['class' => 'input-icheck', 'id' => 'first_day_of_next_month']); !!}
                                @lang('mpcs::lang.first_day_of_next_month')
                            </label> &Tab;
                            {!! Form::select('F21C_first_day_of_next_month_selected', $months, !empty($form_data)? $form_data['F21C_first_day_of_next_month_selected'] : null, ['class' => 'form-control', 'style' => 'width: 100px; float: left; margin-left: 10px; margin-right: 10px;', 'placeholder' => __('lang_v1.please_select')]) !!} @lang('mpcs::lang.month_end')
                        </div>
                        <div class="clearfix"></div>
                        @lang('mpcs::lang.balance_zero_example')
                    </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    {!! Form::text('F159ABC_form_tdate', !empty($form_data) ? $form_data['F159ABC_form_tdate'] :null, ['class' => 'form-control', 'id' => 'F159ABC_setting_tdate',
                    'readonly', 'required', 'placeholder' => __( 'lang_v1.transaction_date' ) ]); !!}
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    {!! Form::text('F159ABC_form_sn', !empty($form_data) ? $form_data['F159ABC_form_sn'] :null, ['class' => 'form-control', 'id' => 'F159ABC_setting_sn',
                    'required', 'placeholder' => __( 'mpcs::lang.form_starting_number' ) ]); !!}
                </div>
            </div>
            <div class="clearfix"></div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('F159ABC_first_day_after_stock_taking', 1, !empty($form_data) ? $form_data['F159ABC_first_day_after_stock_taking'] : false , ['class' =>
                                'input-icheck', 'id' => 'first_day_after_stock_taking']); !!}
                                @lang('mpcs::lang.first_day_after_stock_taking')
                            </label>
                        </div>
                        <div class="checkbox">
                            <label style="float:left;">
                                {!! Form::checkbox('F159ABC_first_day_of_next_month', 1, !empty($form_data) ? $form_data['F159ABC_first_day_of_next_month'] : false , ['class' => 'input-icheck',
                                'id' => 'first_day_of_next_month']); !!}
                                @lang('mpcs::lang.first_day_of_next_month')
                            </label> &Tab;
                            {!! Form::select('F159ABC_first_day_of_next_month_selected', $months, !empty($form_data) ? $form_data['F159ABC_first_day_of_next_month_selected'] : null, ['class' =>
                            'form-control', 'style' => 'width: 100px; float: left; margin-left: 10px; margin-right:
                            10px;', 'placeholder' => __('lang_v1.please_select')]) !!} @lang('mpcs::lang.month_end')
                        </div>
                        <div class="clearfix"></div>
