    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="form-group col-sm-12">
          ...
          {!! Form::text('prefix', null, ['class' => 'form-control', 'placeholder' => __( 'fleet::lang.prefix'), 'id'
          => 'prefix']); !!}
        </div>
        <div class="form-group col-sm-12">
          {!! Form::label('starting_number', __( 'fleet::lang.starting_number' ) . ':*') !!}
          {!! Form::text('starting_number', null, ['class' => 'form-control', 'placeholder' => __( 'fleet::lang.starting_number'), 'id'
          => 'starting_number']); !!}
        </div>
