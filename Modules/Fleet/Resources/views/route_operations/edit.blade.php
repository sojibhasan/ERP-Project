...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    {!! Form::label('product_id', __( 'fleet::lang.product' )) !!}
                    {!! Form::select('product_id', $products , $transaction->route_operation->product_id, ['class' => 'form-control
                    select2',
                    'placeholder' => __(
                    'fleet::lang.please_select' ), 'id' => 'product_id']);
                    !!}
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    {!! Form::label('qty', __( 'fleet::lang.qty' )) !!}
            ...
            <div class="col-md-4">
                <div class="form-group">
                    {!! Form::label('helper_id', __( 'fleet::lang.helper' )) !!}
            ...
            <div class="box-body payment_row" data-row_id="0">
                <div id="payment_rows_div">
                    ...
                    @include('fleet::route_operations.partials.payment_row_edit', ['row_index' => $j, 'payment' => $pl, 'removable' =>true ])
                    @php
                        $j++;
                    @endphp
                    @endforeach
                    @else
                    @include('fleet::route_operations.partials.payment_row_edit', ['row_index' => 0, 'removable' =>true])
                    @endif
                </div>
