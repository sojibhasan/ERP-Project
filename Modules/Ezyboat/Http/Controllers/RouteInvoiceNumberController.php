...
use Modules\Ezyboat\Entities\RouteInvoiceNumber;
...
class RouteInvoiceNumberController extends Controller
{
                ...
                ->addColumn(
                    ...
                    function ($row) {
                        ...
                        // if (auth()->user()->can('fleet.route_invoice_numbers.edit')) {
                            $html .= '<li><a href="#" data-href="' . action('\Modules\Ezyboat\Http\Controllers\RouteInvoiceNumberController@edit', [$row->id]) . '" class="btn-modal" data-container=".view_modal"><i class="glyphicon glyphicon-edit"></i> ' . __("messages.edit") . '</a></li>';
                        // }

                        // if (auth()->user()->can('fleet.route_invoice_numbers.delete')) {
                            $html .= '<li><a href="#" data-href="' . action('\Modules\Ezyboat\Http\Controllers\RouteInvoiceNumberController@destroy', [$row->id]) . '" class="delete_button"><i class="fa fa-trash"></i> ' . __("messages.delete") . '</a></li>';
                        // }
                        return $html;
                    }
                )
    ...
    public function create()
    {
        ...
        return view('ezyboat::settings.route_invoice_number.create')->with(compact(
            'business_id'
        ));
    }
    ...
    public function edit($id)
    {
        ...
        return view('ezyboat::settings.route_invoice_number.edit')->with(compact(
