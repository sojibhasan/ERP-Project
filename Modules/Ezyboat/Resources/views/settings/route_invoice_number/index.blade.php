...
<section class="content">
  ...
  @component('components.widget', ['class' => 'box-primary', 'title' => __('ezyboat::lang.all_your_starting_invoice_number')])
  @slot('tool')
  <div class="box-tools ">
    <button type="button" class="btn  btn-primary btn-modal"
      data-href="{{action('\Modules\Ezyboat\Http\Controllers\RouteInvoiceNumberController@create')}}" data-container=".view_modal">
    ...
    <table class="table table-bordered table-striped" id="route_invoice_number_table" style="width: 100%;">
      <thead>
        <tr>
          ...
          <th>@lang('ezyboat::lang.prefix')</th>
          <th>@lang('ezyboat::lang.starting_number')</th>
