<div class="modal-dialog" role="document" style="width: 65%;">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\Visitor\Http\Controllers\VisitorController@store'), 'method' =>
    'post', 'id' => 'visistor_form' ])
    !!}
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
          aria-hidden="true">&times;</span></button>
      <h4 class="modal-title">@lang( 'visitor::lang.add_visitor' )</h4>
    </div>
    ...
    <div class="modal-body">
      <div class="col-md-4">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            {!! Form::text('business_name', $visitor_username, ['class' => 'form-control','placeholder' =>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            {!! Form::text('date_and_time',Carbon::now(), ['class' => 'form-control','placeholder' =>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            {!! Form::text('visited_date', Carbon::now()->format('m/d/Y'), ['class' => 'form-control','placeholder' =>
      ...
      <div class="col-md-4">
        <div class="form-group">
          {!! Form::label('gender', __('business.gender')) !!}
          <div class="input-group">
            <span class="input-group-addon">
              <i class="fa fa-user"></i>
            </span>
      ...
      <div class="col-md-4">
        ...
        <div class="col-md-4">
            <div class="form-group">
              ...
              @endphp
              {!! Form::label('district', __('business.district') . $requireText) !!}
              <div class="input-group">
                ...
                {!! Form::select('districts', $districts, null, ['class'
                ...
                'id'=>'districts_name', 'style'=>'margin: 0px; display: none;']); !!}
                @endif
              </div>
            </div>
        </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <span class="input-group-addon add-town" @if($settings && $settings->enable_add_town==1) style="background-color: #00a65a;border-color: #008d4c;color: #ffff;" @endif>
                 ...
                 {!! Form::select('town', $towns, null, ['class'
    ...
    <div class="modal-footer">
      <button type="submit" class="btn btn-primary" id="save_visitor_btn">@lang( 'messages.save' )</button>
