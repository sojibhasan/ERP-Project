...
<div class="row">
    ...
    @component('components.widget', ['class' => 'box'])
        ...
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('ledger_project_id', __('property::lang.projects') . ':') !!}
                {!! Form::select('ledger_project_id', $properties, null, ['placeholder' => __('lang_v1.please_select'), 'class' => 'form-control select2', 'readonly', 'id' => 'ledger_project_id', 'style' => 'width: 100%;']); !!}
            </div>
        </div>
       
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('ledger_block_id', __('property::lang.block_number') . ':') !!}
                {!! Form::select('ledger_block_id', $blocks ,null, ['placeholder' => __('lang_v1.please_select'), 'class' => 'form-control select2', 'readonly', 'id' => 'ledger_block_id', 'style' => 'width: 100%;']); !!}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
