<div class="modal-dialog" role="document" style="width: 55%">
    <div class="modal-content">
        {!! Form::open(['url' =>
        action('\Modules\Property\Http\Controllers\CloseCurrentSaleController@store',
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('reason_id[]', $reasons, null, ['class'=> 'form-control select2', 'multiple', 'id' => 'reason_id',
                        'style' => 'width: 100%;']) !!}
                    </div>
                </div>
                <div class="col-md-3">
                   <div class="form-group">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('all_payments_completed', 1, 0, ['class' => 'input-icheck',
