<div class="modal-dialog" role="document" style="width: 55%;">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\Property\Http\Controllers\PropertyAccountSettingController@store'),
    'method' =>
    'post', 'id' => 'account_settings_add_form' ]) !!}
    ...
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="form-group col-sm-12">
          ...
          {!! Form::select('income_account_id', $income_not_pen_accounts, null, ['placeholder' => __(
        ...
        <div class="form-group col-sm-12">
          ...
          {!! Form::select('expense_account_id', $expense_accounts, null, ['placeholder' => __( 'messages.please_select'
          ),
          'required', 'class' => 'form-control select2', 'style' => 'width: 100%;']); !!}
        </div>
        <div class="form-group col-sm-12">
          ...
          !!}
          {!! Form::select('interest_income_account_id', $income_accounts, null, ['placeholder' => __(
          'messages.please_select' ),
          'required', 'class' => 'form-control select2', 'style' => 'width: 100%;']); !!}
        </div>
        <div class="form-group col-sm-12">
          {!! Form::label('penalty_income_account_id', __( 'property::lang.select_penalty_income_account' ) . ':*') !!}
          {!! Form::select('penalty_income_account_id', $income_accounts, null, ['placeholder' => __(
          'messages.please_select' ),
          'required', 'class' => 'form-control select2', 'style' => 'width: 100%;']); !!}
        </div>
        <div class="form-group col-sm-12">
          ...
          ':*') !!}
          {!! Form::select('account_receivable_account_id', $account_receivable_accounts, null, ['placeholder' => __(
          'messages.please_select' ),
          'required', 'class' => 'form-control select2', 'style' => 'width: 100%;']); !!}
        </div>
        <div class="form-group col-sm-12">
          {!! Form::label('capital_income_account_id', __( 'property::lang.select_capital_income_account' ) . ':*') !!}
          {!! Form::select('capital_income_account_id', $income_accounts, null, ['placeholder' => __(
          'messages.please_select' ),
      ...
      <div class="row">
        <div class="col-md-12">
          <table class="table table-striped table-bordered" id="account_setting_table" style="width: 100%;">
            ...
            <tbody>
              <tr>
                <td class="income_account_text"></td>
                <td class="expense_account_text"></td>
                <td class="interest_income_account_text"></td>
                <td class="penalty_income_account_text"></td>
                <td class="account_receivable_account_text"></td>
                <td class="capital_income_account_text"></td>
              </tr>
            </tbody>
          </table>
        </div>
