    ...
    <div class="row">
        <div class="col-md-6 col-lg-6 ">
            <div class="row text-center" style="text-align:center;">
                ...
                @endif
                <h1 style="font-size: 42.5px; color: #838383; font-family: monospace">{{!empty($business) ? $business->name : 'SYZYGY' }}</h1>
                <h3 class="text-red" style="font-size: 28px; font-weight: bold; font-family: inherit">
                    @lang('lang_v1.sale_and_customer_payment_dashboard')</h3>
                <h3 style="font-size: 25px; color: #838383; font-family: arial; margin: 15px 10px;">
                    @lang('lang_v1.locked')</h3>
            </div>

            {!! Form::open(['url' => action('Auth\PropertyUserLoginController@login'),
            'method' =>
            'post',
            'id' =>
            'login_form' ]) !!}
            ...
            <div class="row text-center">
                ...
                <button type="submit" class="btn btn-danger" id="check_password_btn" style="border-radius: 0px"><i
        ...
        <div class="col-md-6 col-lg-6 text-center">
            <div class="row">
                <h1 style="font-weight: bold; margin-bottom: 0px; margin-top: 0px;">@lang('lang_v1.today'): {{Carbon::now()->format('m-d-Y')}}
                </h1>
                <h1 style="font-weight: bold; margin-top: 0px">@lang('lang_v1.time'): {{Carbon::now()->format('H:i')}}</h1>
            </div>
            <div class="row">
                    ...
                    <div class="row text-center" id="calc">
                        <div class="calcBG col-md-12 text-center">
                            ...
                            <div class="row">
                                ...
                                <button id="enter" type="button" class="btn btn-success" onclick="enterVal(this.id)">↵</button>
                            </div>
                        </div>
                    </div>
                </div>
