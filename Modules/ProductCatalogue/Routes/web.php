...
Route::group(['middleware' => ['web', 'auth', 'auth', 'SetSessionData', 'language', 'timezone'], 'namespace' => '\Modules\ProductCatalogue\Http\Controllers', 'prefix' => 'product-catalogue'], function () {
