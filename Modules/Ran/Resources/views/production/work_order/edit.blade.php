<div class="modal-dialog" role="document" style="width: 55%;">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('\Modules\Ran\Http\Controllers\WorkOrderController@update', $work_order->id), 'method' => 'put',
        'id' =>
        'add_work_order_form' ]) !!}
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('location_id', $business_locations, $work_order->location_id , ['class' =>
                            'form-control
                            select2
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('goldsmith_id', $goldsmiths, $work_order->goldsmith_id , ['class' =>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('date_and_time', $work_order->date_and_time, ['class' => 'form-control
                            date_and_time',
                            'required', 'readonly',
                            'placeholder' => __(
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('work_order_no', $work_order->work_order_no, ['class' => 'form-control
                            work_order_no',
                            'required', 'readonly',
                            'placeholder' => __(
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('order_delivery_date', $work_order->order_delivery_date, ['class' =>
                            'form-control order_delivery_date',
                            'required', 'readonly',
                            'placeholder' => __(
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('note', $work_order->note, ['class' => 'form-control note',
                            'required', 'rows'=>' 3',
                            'placeholder' => __(
                            'ran::lang.note' ) ]); !!}
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('customer_order_no', [], $work_order->customer_order_no , ['class' =>
                            'form-control select2
                            ', 'required',
                            'placeholder' => __(
                            'ran::lang.please_select' ), 'style' => 'width: 100%;']); !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('customer_id', $customers, $work_order->customer_id , ['class' =>
                            'form-control select2
                            ', 'required',
                            'placeholder' => __(
                            'ran::lang.please_select' ), 'style' => 'width: 100%;']); !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('qty', null, ['class' => 'form-control qty', 'required',
                            'placeholder' => __(
                            'ran::lang.qty' ) ]); !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            !!}
                            {!! Form::text('weight_showroom_product', null, ['class' => 'form-control input_number
                    ...
                    <input type="hidden" name="index" id="index" value="{{$work_order_items->count()}}">
                    <div class="col-md-12">
                        <button type="button"
                    ...
                    <table class="table table-bordered table-striped" id="add_item_work_order_table"
                        ...
                        <tbody>
                            ...
                            @php
                                $product = App\Product::findOrFail($item->item_id);
                            @endphp
                            <tr>
                                <input type="hidden" value="{{$item->id}}" class="id" name="list[{{$i}}][id]">
                                <td><input type="hidden" value="{{$item->item_id}}"
                                        name="list[{{$i}}][item_id]">{{$product->name}}</td>
                                <td><input type="hidden" value="{{$item->qty}}" name="list[{{$i}}][qty]">{{$item->qty}}
                                </td>
                                <td><input type="hidden" value="{{$item->required_qty}}"
                                        name="list[{{$i}}][required_qty]">{{$item->required_qty}}</td>
                                <td><input type="hidden" value="{{$item->weight_showroom_product}}"
                                        name="list[{{$i}}][weight_showroom_product]">{{$item->weight_showroom_product}}
                                </td>
                                <td><input type="hidden" value="{{$item->required_unit_weight}}"
                                        name="list[{{$i}}][required_unit_weight]">{{$item->required_unit_weight}}</td>
                                <td><input type="hidden" value="{{$item->gold_qty}}"
                                        name="list[{{$i}}][gold_qty]">{{$item->gold_qty}}</td>
                                <td><button type="button" class="btn btn-xs btn-danger remove_row"><i
    ...
    $(document).on('click', '.remove_row',function(){
        ...
        $.ajax({
            method: 'delete',
            url: "{{action('\Modules\Ran\Http\Controllers\WorkOrderController@deleteWorkItem')}}",
            data: { id : id },
