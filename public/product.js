...
$(document).ready(function() {
    ...
    $(document).on('change', 'input#single_dpp', function(e) {
        ...
        __write_number_without_decimal_format($('input#single_dpp_inc_tax'), purchase_inc_tax);

        var profit_percent = __read_number($('#profit_percent'));
        var selling_price = __add_percent(purchase_exc_tax, profit_percent);
        __write_number_without_decimal_format($('input#single_dsp'), selling_price);

        var selling_price_inc_tax = __add_percent(selling_price, tax_rate);
        __write_number_without_decimal_format($('input#single_dsp_inc_tax'), selling_price_inc_tax);
    });
