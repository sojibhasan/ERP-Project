...
class ComposerAutoloaderInit36d2a2f3bef1031fafd0f63397f81115
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit36d2a2f3bef1031fafd0f63397f81115::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire36d2a2f3bef1031fafd0f63397f81115($fileIdentifier, $file);
        }
...
function composerRequire36d2a2f3bef1031fafd0f63397f81115($fileIdentifier, $file)
{
