...
class NotificationTemplate extends Model
{
    ...
    public static function customerNotifications()
    {
        return [
            ...
            'customer_notify' => ['name' => __('lang_v1.customer_notify')],
    ...
    public static function businessNotifications()
    {
        return [
            'customer_new_order' => ['name' => __('lang_v1.customer_new_order')],
            'order_confirmed' => ['name' => __('lang_v1.order_confirmed')],
        ];
    }
    ...
    public static function notificationTags()
    {
        ...
        '{paid_amount}', '{due_amount}', '{business_name}', '{business_logo}' , '{customer_name}'];
    }
