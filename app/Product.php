...
class Product extends Model
{
    ...
    */
    ...
    {
        $products = Product::where('business_id', $business_id)->where('category_id', '<>', '1')->get();
    ...
    */
    ...
    {
        return $this->hasMany(\Modules\Petro\Entities\MeterSale::class);
    }
    /**
     * Get the Stock transfer request with the product.
     */
    public function stock_transfer_requests()
    {
        return $this->hasMany(StockTransferRequest::class);
    }
    ...
    {
        return $this->belongsTo(\App\VariationStoreDetail::class ,'id','product_id');
    }
}
