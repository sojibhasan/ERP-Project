...

    {
        ...
        try {
            ...
            if ($transaction->payment_status != 'paid') {
                ...
                $inputs['cheque_date'] = !empty($inputs['cheque_date']) ? $this->transactionUtil->uf_date($inputs['cheque_date']) : $transaction->transaction_date;
            ...
            //if partial amount paid
                ...
                if ($payment['method'] == 'direct_bank_deposit' || $payment['method'] == 'bank_transfer' || $payment['method'] == 'cheque') {
                    ...
                    if (!empty($payment['cheque_date'])) {
                        ...
                        $ap_transaction_data['operation_date'] =  $this->transactionUtil->uf_date($payment['cheque_date']);
