...
class ImportMedicalProductController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($zip_loaded === false) {
            ...
            return view('medical_products_import.index')
        ...
        try {
            ...
            if ($request->hasFile('products_csv')) {
                ...
                foreach ($imported_data as $key => $value) {
                    ...
                    $product_array['country'] = !empty($value[35]) ? $value[35] : null;
            ...
            return redirect('sample-medical-product-import')->with('notification', $output);
        }

        return redirect('sample-medical-product-import')->with('status', $output);
    }
