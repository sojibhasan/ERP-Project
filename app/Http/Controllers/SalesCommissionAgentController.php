...
class SalesCommissionAgentController extends Controller
{
        ...
        if (request()->ajax()) {
            ...
            $users = User::where('business_id', $business_id)
                ...
                ->select([
                    ...
                    'email', 'contact_no', 'address', 'cmmsn_percent', 'commission_type', 'cmmsn_application'
                ]);
            ...
            return Datatables::of($users)
                ...
                ->editColumn('commission_type', '{{ucfirst($commission_type)}}')
                ->editColumn('cmmsn_application', '{{str_replace("_", " ", ucfirst($cmmsn_application) )}}')
                ->removeColumn('id')
                ->rawColumns(['action'])
                ->make(true);
        }
    ...
    public function create()
    {
        ...
        return view('sales_commission_agent.create')->with(compact('units'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $input = $request->only(['surname', 'first_name', 'last_name', 'email', 'address', 'contact_no', 'commission_type', 'cmmsn_percent', 'cmmsn_application']);
            ...
            if ($input['cmmsn_application'] == 'per_unit') {
                $input['cmmsn_units'] = !empty($request->cmmsn_units) ? json_encode($request->cmmsn_units) : '[]';
            } else {
                $input['cmmsn_units'] = '[]';
            }
