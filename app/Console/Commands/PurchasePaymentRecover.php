...
class PurchasePaymentRecover extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:recover_purchase_payment';
    ...
    {
        $transactions = Transaction::where('type', 'purchase')->where('payment_status', 'paid')->get();
