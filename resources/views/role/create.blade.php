...
<section class="content pos-tab-container">
  ...
  <div class="row check_group">
    <div class="col-md-1">
      <h4> <label>@lang( 'role.journal' )</label></h4>
    </div>
    <div class="col-md-2">
      <div class="checkbox">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            ...
            [ 'class' => 'input-icheck']); !!} {{ __( 'role.journal.create' ) }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            ...
            [ 'class' => 'input-icheck']); !!} {{ __( 'role.journal.update' ) }}
          </label>
        </div>
      </div>
  ...
  <hr>
  @if($get_permissions['contact_module'])
  <div class="row check_group">
    <div class="col-md-1">
  ...
  <hr>
  @if($get_permissions['sale_module'])
  <div class="row check_group">
    <div class="col-md-1">
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'account.settings', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'account.settings.edit', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'account.deposit_transfer.edit', false,
  ...
  <hr>
  @endif
  @if($get_permissions['fleet_module'])
  <div class="row check_group">
    <div class="col-md-1">
      <h4><label>@lang( 'role.fleet_module' )</label></h4>
    </div>
    <div class="col-md-2">
      <div class="checkbox">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'fleet.access', false,
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'fleet.routes.edit', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'fleet.routes.delete', false,
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'fleet.drivers.edit', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.edit') }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'fleet.drivers.delete', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.delete') }}
          </label>
        </div>
      </div>
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'fleet.helpers.edit', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.edit') }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'fleet.helpers.delete', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.delete') }}
          </label>
        </div>
      </div>
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'pump_operator.main_system', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'pump_operator.access_code', false,
  ...
  <div class="row check_group">
    <div class="col-md-1">
      <h4><label>@lang( 'role.daily_pump_status' )</label></h4>
    </div>
    <div class="col-md-2">
      <div class="checkbox">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'daily_pump_status.edit', false,
            [ 'class' => 'input-icheck']); !!} {{ __( 'role.edit' ) }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'daily_pump_status.delete', false,
            [ 'class' => 'input-icheck']); !!} {{ __( 'role.delete' ) }}
          </label>
        </div>
      </div>
  ...
  <hr>
  @endif
  @if($get_permissions['property_module'])
  <div class="row">
    <div class="col-md-3">
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.purchase.view', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.purchase.create', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.purchase.edit', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.edit') }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.purchase.delete', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.delete') }}
          </label>
        </div>
      </div>
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.list.view', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.view') }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.list.create', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.create') }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.list.edit', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.edit') }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.list.delete', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.delete') }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property_finalize.edit', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property_account_settings.edit', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property_penalty.delete', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'list_easy_payments.access', false,
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.settings.access', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.settings.unit', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.settings.tax', false,
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.customer.view', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.view') }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.customer.create', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.create') }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.customer.edit', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.edit') }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.customer.delete', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.delete') }}
          </label>
        </div>
      </div>
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.project_dashboard.sell_land_blocks', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.project_dashboard.customer_payments', false,
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.current_sale.edit', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.edit') }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.current_sale.view', false,
            [ 'class' => 'input-icheck']); !!} {{ __('role.view') }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.current_sale.close.create', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.current_sale.close.edit', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'property.add_new_sale', false,
