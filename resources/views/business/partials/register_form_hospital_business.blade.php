...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::password('password', ['class' => 'form-control','placeholder' => __('business.password'), 'style' => 'margin:0px;',  'required']); !!}
        </div>
    </div>
</div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::password('confirm_password', ['class' => 'form-control','placeholder' => __('business.confirm_password'), 'style' => 'margin:0px;', 'required']); !!}
        </div>
    </div>
</div>
<div class="clearfix"></div>
