...
<body
 ...
 <img src="{{url($url_img)}}" alt="logo" style="margin:  20px auto 20px auto; height: 150px; width: 200px;">
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="https://syz4.xyz/pos2020/public"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Please confirm Offline Payment for subscription</p>
                                        <p
                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            {{$details}}</p>
                                        <p
                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            To confirm go to superadmin subscriptions tab and confirm it.</p>
                                        <p
                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Regards,<br></p>
