...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.business_notifications') . ':'])
                @include('notification_template.partials.tabs', ['templates' => $business_notifications])
            @endcomponent
        </div>
    </div>
    <div class="row">
