...
<!-- Main Header -->
  <header class="main-header no-print">
    <a href="{{route('home')}}" class="logo" style="background: {{ $top_belt_bg}};">
      ...
      <span class="logo-lg">{{ Auth::User()->first_name .' '. Auth::User()->last_name }}</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  {{-- <a href="{{action('\Modules\Member\Http\Controllers\EmployeeController@getProfile')}}" class="btn btn-default btn-flat">@lang('lang_v1.profile')</a> --}}
                </div>
