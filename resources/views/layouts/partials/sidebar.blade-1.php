      ...
      <ul class="sidebar-menu">
        @if(session()->get('business.is_patient'))
          <li class="{{ $request->segment(1) == 'patient' ? 'active' : '' }}">
            <a href="{{action('PatientController@index')}}">
        ...
        @if(session()->get('business.is_hospital'))
          <li class="{{ $request->segment(1) == 'patient' ? 'active' : '' }}">
            <a href="{{action('HospitalController@index')}}">
              <i class="fa fa-dashboard"></i> <span>
            @lang('home.home')</span>
            </a>
          </li>
        ...
        @if ($is_admin)
          ...
          @if(request()->session()->get('business.is_patient'))
            <li
                    class="treeview @if( in_array($request->segment(1), ['family-members', 'superadmin', 'pay-online'])) {{'active active-sub'}} @endif">
            ...
            <i class="fa fa-angle-left pull-right"></i>
              ...
              <ul class="treeview-menu">
                <li class="{{ $request->segment(1) == 'family-member' ? 'active' : '' }}">
                  <a href="{{action('FamilyController@index')}}"><i class="fa fa-users"></i>
                    @lang('patient.family_member')</a>
                </li>
                <li class="{{ $request->segment(2) == 'family-subscription' ? 'active' : '' }}">
                  <a href="{{action('\Modules\Superadmin\Http\Controllers\FamilySubscriptionController@index')}}"><i class="fa fa-users"></i>
                    @lang('patient.family_subscription')</a>
                </li>
      ...
      <!-- <li class="header">HEADER</li> -->
        ...
        @if(auth()->user()->is_pump_operator)
          @if(auth()->user()->can('pump_operator.dashboard'))
            <li class="{{ $request->segment(1) == 'petro' && $request->segment(2) == 'pump-operators' && $request->segment(3) == 'dashboard' ? 'active' : '' }}"><a
                      href="{{action('\Modules\Petro\Http\Controllers\PumpOperatorController@dashboard')}}"><i class="fa fa-tachometer"></i> <span>@lang('petro::lang.dashboard')</span></a>
            </li>
          @endif
          <li class="{{ $request->segment(1) == 'petro' && $request->segment(2) == 'pump-operators' && $request->segment(3) == 'pumper-day-entries' ? 'active' : '' }}"><a
                    href="{{action('\Modules\Petro\Http\Controllers\PumperDayEntryController@index')}}"><i class="fa fa-calculator"></i> <span>@lang('petro::lang.pumper_day_entries')</span></a>
          </li>
        @endif
        ...
        @if(auth()->user()->is_customer == 0)
          @if(auth()->user()->can('crm.view'))
            ...
            <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                  @can('crm.view')
                    <li class="{{ $request->segment(1) == 'crm' && $request->input('type') == 'customer' ? 'active' : '' }}"><a
                              href="{{action('CRMController@index')}}"><i class="fa fa-star"></i> @lang('lang_v1.crm')</a></li>

                    <li class="{{ $request->segment(1) == 'crmgroups' ? 'active' : '' }}"><a
                              href="{{action('CrmGroupController@index')}}"><i class="fa fa-object-group"></i>
                        @lang('lang_v1.crm_group')</a></li>
                  @endcan
                  <li class="{{ $request->segment(1) == 'crm-activity' ? 'active' : '' }}"><a
                            href="{{action('CRMActivityController@index')}}"><i class="fa fa-object-group"></i>
                      @lang('lang_v1.crm_activity')</a></li>
                </ul>
              </li>
            @endif
          @endif
        ...
        @if($contact_module)
          @if(auth()->user()->can('supplier.view') || auth()->user()->can('customer.view') )
            <li
                    class="treeview {{ in_array($request->segment(1), ['contacts', 'customer-group', 'contact-group', 'customer-reference', 'customer-statement', 'outstanding-received-report']) ? 'active active-sub' : '' }}"
                    id="tour_step4">
            ...
            <i class="fa fa-angle-left pull-right"></i>
              ...
              <ul class="treeview-menu">
                ...
                @if($contact_supplier)
                  @can('supplier.view')
                    <li class="{{ $request->input('type') == 'supplier' ? 'active' : '' }}"><a
                              href="{{action('ContactController@index', ['type' => 'supplier'])}}"><i class="fa fa-star"></i>
                ...
                @can('customer.view')
                  ...
                  <li class="{{ $request->segment(1) == 'contact-group' ? 'active' : '' }}"><a
                            href="{{action('ContactGroupController@index')}}"><i class="fa fa-users"></i>
                      @lang('lang_v1.contact_groups')</a></li>
                    @endif
                @endcan
                ...
                @if($customer_reference)
                    @if($enable_petro_module && $contact_customer && !$property_module)
                      <li class="{{ $request->segment(1) == 'customer-reference' ? 'active' : '' }}"><a
                                href="{{action('CustomerReferenceController@index')}}"><i class="fa fa-link"></i>
                          @lang('lang_v1.customer_reference')</a></li>
                    @endif
                @endif

                @if($contact_customer)
                    @if($customer_statement)
                    <li class="{{ $request->segment(1) == 'customer-statement' ? 'active' : '' }}"><a
                            href="{{action('CustomerStatementController@index')}}"><i class="fa fa-paperclip"></i>
                      @lang('contact.customer_statements')</a></li>
                    @endif
                    @if($customer_payment)
                    <li class="{{ $request->segment(1) == 'customer-payment-simple' ? 'active' : '' }}"><a
                            href="{{action('CustomerPaymentController@index')}}"><i class="fa fa-money"></i>
                      @lang('lang_v1.customer_payments')</a></li>
                    @endif
                    @if($outstanding_received)
                    <li class="{{ $request->segment(1) == 'outstanding-received-report' ? 'active' : '' }}"><a
                            href="{{action('ContactController@getOutstandingReceivedReport')}}"><i class="fa fa-arrow-right"></i>
                      @lang('lang_v1.outstanding_received')</a></li>
                    @endif
                @endif
                @if($contact_supplier)
                    @if($issue_payment_detail)
                        <li class="{{ $request->segment(1) == 'issued-payment-details' ? 'active' : '' }}"><a
                                href="{{action('ContactController@getIssuedPaymentDetails')}}"><i class="fa fa-arrow-left"></i>
                          @lang('lang_v1.issued_payment_details')</a></li>
                      @endif
                @endif
              </ul>
            </li>
        ...
        @if($products)
          ...
          auth()->user()->can('category.create') )
            <li
                    class="treeview {{ in_array($request->segment(1), ['variation-templates', 'products', 'labels', 'import-products', 'import-opening-stock', 'selling-price-group', 'brands', 'units', 'categories', 'warranties']) ? 'active active-sub' : '' }}"
                    id="tour_step5">
            ...
            <i class="fa fa-angle-left pull-right"></i>
              ...
              <ul class="treeview-menu">
                @can('product.view')
                  <li class="{{ $request->segment(1) == 'products' && $request->segment(2) == '' ? 'active' : '' }}"><a
                            href="{{action('ProductController@index')}}"><i class="fa fa-list"></i>@lang('lang_v1.list_products')</a>
                  </li>
                @endcan
                @can('product.create')
                  <li class="{{ $request->segment(1) == 'products' && $request->segment(2) == 'create' ? 'active' : '' }}"><a
                            href="{{action('ProductController@create')}}"><i
                              class="fa fa-plus-circle"></i>@lang('product.add_product')</a></li>
                @endcan
                @can('product.view')
                  <li class="{{ $request->segment(1) == 'labels' && $request->segment(2) == 'show' ? 'active' : '' }}"><a
                            href="{{action('LabelsController@show')}}"><i class="fa fa-barcode"></i>@lang('barcode.print_labels')</a>
                  </li>
                @endcan
                @can('product.create')
                ...
                @if(session()->get('business.is_pharmacy'))
                  <li class="{{ $request->segment(1) == 'sample-medical-product-list' ? 'active' : '' }}"><a
                            href="{{action('SampleMedicalProductController@index')}}"><i
                              class="fa fa-download"></i><span>@lang('lang_v1.sample_medical_product_list')</span></a></li>
                @endif
      ...
      <!-- Start Petro Module -->
        @if($enable_petro_module)
          @if(auth()->user()->can('petro.access'))
            @includeIf('petro::layouts.partials.sidebar')
          @endif
        @endif
      <!-- End Petro Module -->
        ...
        @if($mpcs_module)
          @if(auth()->user()->can('mpcs.access'))
            @includeIf('mpcs::layouts.partials.sidebar')
          @endif
        @endif
      <!-- End MPCS Module -->
        ...
        @if($fleet_module)
          @if(auth()->user()->can('fleet.access'))
            @includeIf('fleet::layouts.partials.sidebar')
          @endif
        @endif
      <!-- End Fleet Module -->
        ...
        @if($ezyboat_module)
          ...
          @includeIf('ezyboat::layouts.partials.sidebar')
          {{-- @endif --}}
        @endif
      <!-- End Ezyboat Module -->
        ...
        @if($ran_module)
          @if(auth()->user()->can('ran.access'))
            @includeIf('ran::layouts.partials.sidebar')
          @endif
        @endif
      <!-- End Gold Module -->
          ...
          @if($mf_module)
            @if(auth()->user()->is_customer == 0)
              @if(auth()->user()->can('manufacturing.access_recipe') || auth()->user()->can('manufacturing.access_production') )
                @include('manufacturing::layouts.partials.sidebar')
              @endif
            @endif
          @endif
        @endif
        ...
        @if($purchase)
          @if(in_array('purchase', $enabled_modules))
            ...
            auth()->user()->can('purchase.update') )
              <li
                      class="treeview {{in_array($request->segment(1), ['purchases', 'purchase-return', 'import-purchases']) ? 'active active-sub' : '' }}"
                      id="tour_step6">
            ...
            <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                  @can('purchase.view')
                    <li class="{{ $request->segment(1) == 'purchases' && $request->segment(2) == null ? 'active' : '' }}"><a
                              href="{{action('PurchaseController@index')}}"><i
                                class="fa fa-list"></i>@lang('purchase.list_purchase')</a></li>
                  @endcan
                  {{-- @can('purchase.create') --}}
                  <li class="{{ $request->segment(1) == 'purchases' && $request->segment(2) == 'add-purchase-bulk' ? 'active' : '' }}"><a
                            href="{{action('PurchaseController@addPurchaseBulk')}}"><i class="fa fa-stack-exchange"></i>
                      @lang('purchase.add_purchase_bulk')</a></li>
                  {{-- @endcan --}}
                  @can('purchase.create')
                    <li class="{{ $request->segment(1) == 'purchases' && $request->segment(2) == 'create' ? 'active' : '' }}"><a
                              href="{{action('PurchaseController@create')}}"><i class="fa fa-plus-circle"></i>
                  ...
                  <li class="{{ $request->segment(1) == 'import-purchases'? 'active' : '' }}"><a
                            href="{{action('ImportPurchasesController@index')}}"><i
                              class="fa fa-recycle"></i>@lang('lang_v1.import_purchases')</a></li>
                </ul>
              </li>
            @endif
          @endif
        ...
        @if($sale_module)
          @if(in_array('add_sale', $enabled_modules))
            ...
            auth()->user()->can('direct_sell.access') || auth()->user()->can('view_own_sell_only'))
              <li
                      class="treeview {{  in_array( $request->segment(1), ['sales', 'pos', 'sell-return', 'ecommerce', 'discount', 'shipments', 'import-sales', 'reserved-stocks']) ? 'active active-sub' : '' }}"
                      id="tour_step7">
                ...
                <ul class="treeview-menu">
                  @if($all_sales)
                    @if(auth()->user()->can('direct_sell.access') || auth()->user()->can('view_own_sell_only'))
                      <li class="{{ $request->segment(1) == 'sales' && $request->segment(2) == null ? 'active' : '' }}"><a
                                href="{{action('SellController@index')}}"><i class="fa fa-list"></i>@lang('lang_v1.all_sales')</a></li>
                    @endif
                  @endif
                <!-- Call superadmin module if defined -->
                  @if(Module::has('Ecommerce'))
                  ...
                  @if($add_sale)
                    @can('direct_sell.access')
                      <li class="{{ $request->segment(1) == 'sales' && $request->segment(2) == 'create' ? 'active' : '' }}"><a
                  ...
                  @if($list_pos)
                    @can('sell.view')
                      <li class="{{ $request->segment(1) == 'pos' && $request->segment(2) == null ? 'active' : '' }}"><a
                                href="{{action('SellPosController@index')}}"><i class="fa fa-list"></i>@lang('sale.list_pos')</a></li>
                    @endcan
                  @endif

                  @if(in_array('pos_sale', $enabled_modules))
                    @can('sell.create')
                      <li class="{{ $request->segment(1) == 'pos' && $request->segment(2) == 'create' ? 'active' : '' }}"><a
                                href="{{action('SellPosController@create')}}"><i class="fa fa-plus-circle"></i>@lang('sale.pos_sale')</a>
                      </li>
                    @endcan
                  @endif
                  ...
                  @if($list_draft)
                    @can('list_drafts')
                      <li class="{{ $request->segment(1) == 'sales' && $request->segment(2) == 'drafts' ? 'active' : '' }}"><a
                                href="{{action('SellController@getDrafts')}}"><i class="fa fa-pencil-square"
                                                                                 aria-hidden="true"></i>@lang('lang_v1.list_drafts')</a></li>
                    @endcan
                  @endif

                  @if($list_quotation)
                    @can('list_quotations')
                      <li class="{{ $request->segment(1) == 'sales' && $request->segment(2) == 'quotations' ? 'active' : '' }}"><a
                                href="{{action('SellController@getQuotations')}}"><i class="fa fa-pencil-square"
                                                                                     aria-hidden="true"></i>@lang('lang_v1.list_quotations')</a></li>
                    @endcan
                  @endif

                  @if($customer_order_own_customer == 1 || $customer_order_general_customer == 1)
                    @if($list_orders)
                      <li class="{{ $request->segment(1) == 'sales' && $request->segment(2) == 'customer-orders' ? 'active' : '' }}"><a
                                href="{{action('SellController@getCustomerOrders')}}"><i class="fa fa-pencil-square"
                                                                                         aria-hidden="true"></i>@lang('lang_v1.list_orders')</a></li>
                    @endif
                    @if($upload_orders)
                      <li class="{{ $request->segment(1) == 'sales' && $request->segment(2) == 'customer-orders' ? 'active' : '' }}"><a
                                href="{{action('SellController@getCustomerUploadedOrders')}}"><i class="fa fa-upload"
                                                                                                 aria-hidden="true"></i>@lang('customer.uploaded_orders')</a></li>
                    @endif
                  @endif

                  @if($list_sell_return)
                    @can('sell.view')
                      <li class="{{ $request->segment(1) == 'sell-return' && $request->segment(2) == null ? 'active' : '' }}"><a
                                href="{{action('SellReturnController@index')}}"><i
                                  class="fa fa-undo"></i>@lang('lang_v1.list_sell_return')</a></li>
                    @endcan
                  @endif

                  @if($shipment)
                    @can('access_shipping')
                      <li class="{{ $request->segment(1) == 'shipments' ? 'active' : '' }}"><a
                                href="{{action('SellController@shipments')}}"><i class="fa fa-truck"></i>@lang('lang_v1.shipments')</a>
                      </li>
                    @endcan
                  @endif
                  ...
                  @if($discount)
                    @can('discount.access')
                      <li class="{{ $request->segment(1) == 'discount' ? 'active' : '' }}"><a
                                href="{{action('DiscountController@index')}}"><i class="fa fa-percent"></i>@lang('lang_v1.discounts')</a>
                      </li>
                    @endcan
                  @endif
                  ...
                  @if($import_sale)
                    <li class="{{ $request->segment(1) == 'import-sales'? 'active' : '' }}"><a
                              href="{{action('ImportSalesController@index')}}"><i
                                class="fa fa-recycle"></i>@lang('lang_v1.import_sales')</a></li>
                  @endif

                  @if($reserved_stock)
                    <li class="{{ $request->segment(1) == 'reserved-stocks'? 'active' : '' }}"><a
                              href="{{action('ReservedStocksController@index')}}"><i
                                class="fa fa-recycle"></i>@lang('lang_v1.reserved_stocks')</a></li>
                  @endif
                  @if($customer_settings)
                    @if($over_limit_sales)
                      <li class="{{ $request->segment(1) == 'sales' && $request->segment(2) == 'over-limit-sales' ? 'active' : '' }}"><a
                                href="{{action('SellController@overLimitSales')}}"><i class="fa fa-plus-circle"></i>@lang('sale.over_limit_sales')</a>
                      </li>
                    @endif
                  @endif
                </ul>
        ...
        @if(Module::has('Repair'))
          @if($repair_module)
            @if(auth()->user()->can('repair.access'))
              <li class="{{ $request->segment(1) == 'repair' ? 'active' : '' }}"><a
                        href="{{action('\Modules\Repair\Http\Controllers\DashboardController@index')}}"><i
                          class="fa fa-wrench"></i><span>@lang('lang_v1.repair')</span></a></li>
            @endif
          @endif
        @endif

        @if($stock_transfer)
          @if(in_array('stock_transfer', $enabled_modules))
            @if(auth()->user()->can('purchase.view') || auth()->user()->can('purchase.create') )
            ...
            <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                  @can('purchase.view')
                    <li class="{{ $request->segment(1) == 'stock-transfers' && $request->segment(2) == null ? 'active' : '' }}"><a
                              href="{{action('StockTransferController@index')}}"><i
                  ...
                  {{-- @can('purchase.create') --}}
                  <li
                          class="{{ $request->segment(1) == 'stock-transfers-request' && $request->segment(2) == null ? 'active' : '' }}">
                    <a href="{{action('StockTransferRequestController@index')}}"><i
                              class="fa fa-question-circle"></i>@lang('lang_v1.stock_transfer_request')</a></li>
                  {{-- @endcan --}}
                  <li>
                    <a href="{{ url('List_Store_Transaction') }}"><i
                              class="fa fa-list"></i>@lang('lang_v1.list_store_transactions')</a></li>
                              <li>
...
{{--        @endif--}}
        ...
        @if($expenses)
          @if(in_array('expenses', $enabled_modules))
            ...
            <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                  <li class="{{ $request->segment(1) == 'expenses' && empty($request->segment(2)) ? 'active' : '' }}"><a
                            href="{{action('ExpenseController@index')}}"><i class="fa fa-list"></i>@lang('lang_v1.list_expenses')</a>
                  </li>
                  <li class="{{ $request->segment(1) == 'expenses' && $request->segment(2) == 'create' ? 'active' : '' }}"><a
                            href="{{action('ExpenseController@create')}}"><i class="fa fa-plus-circle"></i>@lang('messages.add')
                      @lang('expense.expenses')</a></li>
      ...
      <!-- Start hr Module -->
        @if($hr_module)
          @includeIf('hr::layouts.partials.sidebar')
        @endif
      <!-- End hr Module -->
      ...
      <!-- Start PayRoll Module -->
        @if($payday)
            @if(auth()->user()->can('payday') && !auth()->user()->is_pump_operator && !auth()->user()->is_property_user)
                <li>
                    <a href="javascript:void(0);" id="login_payroll">
                        <i class="fa fa-briefcase"></i> <span> PayRoll</span>
                    </a>
                </li>
            @endif
        @endif
      ...
      <!-- End Task Management Module -->
        ...
        @if($banking_module || $access_account)
          @if(in_array('account', $enabled_modules) || in_array('banking_module', $enabled_modules))
            @can('account.access')
              <li class="treeview {{ $request->segment(1) == 'accounting-module' ? 'active active-sub' : '' }}">
                <a href="#"><i class="fa fa-money" aria-hidden="true"></i> <span>@if($access_account) @lang('account.accounting_module') @else @lang('account.banking_module') @endif</span>
                  <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
                </a>
                <ul class="treeview-menu">
                  <li class="{{ $request->segment(1) == 'accounting-module' && $request->segment(2) == 'account' ? 'active' : '' }}"><a
                            href="{{action('AccountController@index')}}"><i class="fa fa-list"></i>@lang('account.list_accounts')</a>
                  </li>

                  <li class="{{ $request->segment(1) == 'accounting-module' && $request->segment(2) == 'disabled-account' ? 'active' : '' }}"><a
                            href="{{action('AccountController@disabledAccount')}}"><i class="fa fa-times"></i>@lang('account.disabled_account')</a>
                  </li>

                  <li class="{{ $request->segment(1) == 'accounting-module' && $request->segment(2) == 'journals' ? 'active' : '' }}"><a
                            href="{{action('JournalController@index')}}"><i class="fa fa-book"></i>@lang('account.list_journals')</a>
                  </li>

                  <li class="{{ $request->segment(1) == 'accounting-module' && $request->segment(2) == 'get-profit-loss-report' ? 'active' : '' }}"><a
                            href="{{action('AccountController@getProfitLossReport')}}"><i class="fa fa-file-text"></i>@lang('lang_v1.profit_loss_report')</a>
                  </li>

                  <li class="{{ $request->segment(1) == 'accounting-module' && $request->segment(2) == 'income-statement' ? 'active' : '' }}"><a
                            href="{{action('AccountReportsController@incomeStatement')}}"><i class="fa fa-book"></i>@lang('account.income_statement')</a>
                  </li>

                  <li
                          class="{{ $request->segment(1) == 'accounting-module' && $request->segment(2) == 'balance-sheet' ? 'active' : '' }}">
                    <a href="{{action('AccountReportsController@balanceSheet')}}"><i
                              class="fa fa-book"></i>@lang('account.balance_sheet')</a></li>

                  <li
                          class="{{ $request->segment(1) == 'accounting-module' && $request->segment(2) == 'trial-balance' ? 'active' : '' }}">
                    <a href="{{action('AccountReportsController@trialBalance')}}"><i
                              class="fa fa-balance-scale"></i>@lang('account.trial_balance')</a></li>

                  <li class="{{ $request->segment(1) == 'accounting-module' && $request->segment(2) == 'cash-flow' ? 'active' : '' }}"><a
                            href="{{action('AccountController@cashFlow')}}"><i
                              class="fa fa-exchange"></i>@lang('lang_v1.cash_flow')</a></li>

                  <li
                          class="{{ $request->segment(1) == 'accounting-module' && $request->segment(2) == 'payment-account-report' ? 'active' : '' }}">
                    <a href="{{action('AccountReportsController@paymentAccountReport')}}"><i
                              class="fa fa-file-text-o"></i>@lang('account.payment_account_report')</a></li>

                  <li
                          class="{{ $request->segment(1) == 'accounting-module' && $request->segment(2) == 'import' ? 'active' : '' }}">
                    <a href="{{action('AccountController@getImportAccounts')}}"><i
                              class="fa fa-download"></i>@lang('lang_v1.import_accounts')</a></li>
              ...
              <ul class="treeview-menu">
                @if($product_report)
                    ...
                    || auth()->user()->can('product_transaction_report.view')
                      ...
                      <li class="{{ $request->segment(2) == 'product' ? 'active' : '' }}"><a
                                href="{{action('ReportController@getProductReport')}}"><i
                                  class="fa fa-hourglass-half"></i>@lang('report.product_report')</a>
                      </li>
                    @endif
                @endif
                @if($payment_status_report)
                    ...
                    || auth()->user()->can('aging_report.view')
                      ...
                      <li class="{{ $request->segment(2) == 'payment-status' ? 'active' : '' }}"><a
                                href="{{action('ReportController@getPaymentStatusReport')}}"><i
                                  class="fa fa-money"></i>@lang('report.payment_status_report')</a>
                      </li>
                    @endif
                @endif
                ...
                || auth()->user()->can('profit_loss_report.view')
                  ...
                  <li class="{{ $request->segment(2) == 'management' ? 'active' : '' }}"><a
                            href="{{action('ReportController@getManagementReport')}}"><i
                              class="fa fa-briefcase"></i>@lang('report.management_report')</a>
                  </li>
                @endif

                @if($verification_report)
                  <li class="{{ $request->segment(2) == 'verification' ? 'active' : '' }}"><a
                            href="{{action('ReportController@getVerificationReport')}}"><i
                              class="fa fa-check-circle"></i>@lang('report.verification_reports')</a>
                  </li>
                @endif
                ...
                @if($activity_report)
                    ...
                    || auth()->user()->can('tax_report.view')
                      ...
                      <li class="{{ $request->segment(2) == 'activity' ? 'active' : '' }}"><a
                                href="{{action('ReportController@getActivityReport')}}"><i
                                  class="fa fa-user-secret"></i>@lang('report.activity_report')</a>
                      </li>
                    @endif
                @endif
                @if($contact_report)
                    @can('contact_report.view')
                      <li class="{{ $request->segment(2) == 'contact' ? 'active' : '' }}"><a
                                href="{{action('ReportController@getContactReport')}}"><i
                                  class="fa fa-address-book"></i>@lang('report.contact_report')</a></li>
                    @endcan
                @endif
                ...
                @if($trending_product)
                    @can('trending_products.view')
                      <li class="{{ $request->segment(2) == 'trending-products' ? 'active' : '' }}"><a
                                href="{{action('ReportController@getTrendingProducts')}}"><i class="fa fa-line-chart"
                ...
                @can('user_activity.view')
                  <li class="{{ $request->segment(2) == 'user_activity' ? 'active' : '' }}"><a
                            href="{{action('ReportController@getUserActivityReport')}}"><i class="fa fa-eercast"
                                                                                           aria-hidden="true"></i>@lang('report.user_activity')</a></li>
                @endcan
                @endif
        ...
        @if($catalogue_qr)
          @if(auth()->user()->can('catalogue.access'))
            <li class="treeview {{  in_array( $request->segment(1), ['backup']) ? 'active active-sub' : '' }}">
              <a href="{{action('\Modules\ProductCatalogue\Http\Controllers\ProductCatalogueController@generateQr')}}"><i class="fa fa-qrcode"></i>
      ...
      <!-- Call restaurant module if defined -->
        @if($enable_booking) <!-- check if module in subscription -->
        ...
        @if($notification_template_module)
          @can('send_notifications')
            <li class="treeview {{  $request->segment(1) == 'notification-templates' ? 'active active-sub' : '' }}">
              <a href=""><i class="fa fa-envelope"></i> <span>@lang('lang_v1.notification_templates')</span>
                <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
              </a>
                ...
                @if($enable_sms)
                  @can('sms.view')
                    <li class="{{ $request->segment(2) == 'sms-template' ? 'active' : '' }}">
                      <a href="{{ url('notification-templates/sms-template')}}"><i class="fa fa-commenting-o"></i>
                        @lang('lang_v1.sms_template')</a>
                    </li>
                  @endcan
                @endif
                <li class="{{ $request->segment(2) == 'email-template' ? 'active' : '' }}">
                  <a href="{{ url('notification-templates/email-template')}}"><i class="fa fa-envelope-o"></i>
                    @lang('lang_v1.email_template')</a>
                </li>
              </ul>
            </li>
          @endif
            ...
            <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu" id="tour_step3">
                  @if($settings_module)
                      ...
                      @if($business_settings)
                        <li class="{{ $request->segment(1) == 'business' ? 'active' : '' }}">
                          <a href="{{action('BusinessController@getBusinessSettings')}}" id="tour_step2"><i class="fa fa-cogs"></i>
                            @if($business_or_entity == 'business'){{ __('business.business_settings') }}  @elseif($business_or_entity == 'entity'){{ __('lang_v1.entity_settings') }} @else {{ __('business.business_settings') }} @endif</a>
                        </li>
                      @endif
                      @if($business_location)
                        <li class="{{ $request->segment(1) == 'business-location' ? 'active' : '' }}">
                          <a href="{{action('BusinessLocationController@index')}}"><i class="fa fa-map-marker"></i>
                            @if($business_or_entity == 'business'){{ __('business.business_locations') }} @elseif($business_or_entity == 'entity'){{ __('lang_v1.entity_locations') }} @else {{ __('business.business_locations') }} @endif</a>
                        </li>
                      @endif
                      @if(!$property_module)
                        <li class="{{ $request->segment(1) == 'stores' ? 'active' : '' }}">
                          <a href="{{action('StoreController@index')}}"><i class="fa fa-stack-exchange"></i>
                            @lang('business.stores_settings')</a>
                        </li>
                      @endif
                    @endcan
                      ...
                      @if($customer_settings)
                        @if(auth()->user()->can('customer_settings.access'))
                          <li class="{{ $request->segment(1) == 'customer-settings' ? 'active' : '' }}">
                            <a href="{{action('CustomerSettingsController@index')}}"><i class="fa fa-bolt"></i>
                              <span>@lang('lang_v1.customer_settings')</span></a>
                          </li>
                        @endif
                      @endif
                    ...
                    @if(in_array('type_of_service', $enabled_modules) && !$property_module)
                      <li class="{{  $request->segment(1) == 'types-of-service' ? 'active active-sub' : '' }}">
                        <a href="{{action('TypesOfServiceController@index')}}"><i class="fa fa-user-circle-o"></i>
          ...
          @if($sms_module)
            @can('sms.access')
              @includeIf('sms::layouts.partials.sidebar')
            @endcan
          @endif

          @if($member_registration)
            @can('member.access')
              @includeIf('member::layouts.partials.sidebar')
            @endcan
          @endif
          ...
          @if(auth()->user()->hasRole('Super Manager#1'))
            <li
                    class="treeview {{ in_array($request->segment(1), ['super-manager']) ? 'active active-sub' : '' }}">
              <a href="#">
          ...
          @if($visitors_registration_module)
            @includeIf('visitor::layouts.partials.sidebar')
          @endif

          @if($user_management_module)
        ...
        <!-- only customer accessable pages -->
          @if(auth()->user()->is_customer == 1)
            <li
                    class="treeview {{  in_array( $request->segment(1), ['customer-sales', 'customer-sell-return', 'customer-order', 'customer-order-list']) ? 'active active-sub' : '' }}"
                    id="">
            ...
            <i class="fa fa-angle-left pull-right"></i>
              ...
              <ul class="treeview-menu">
                ...
                <li class="{{ $request->segment(1) == 'customer-sales' ? 'active' : '' }}"><a
                          href="{{action('CustomerSellController@index')}}"><i class="fa fa-list"></i>@lang('lang_v1.all_sales')</a></li>

                <li class="{{ $request->segment(1) == 'customer-sell-return'  ? 'active' : '' }}"><a
                          href="{{action('CustomerSellReturnController@index')}}"><i
                            class="fa fa-undo"></i>@lang('lang_v1.list_sell_return')</a></li>

                <li class="{{ $request->segment(1) == 'customer-order' ? 'active' : '' }}"><a
                          href="{{action('CustomerOrderController@create')}}"><i class="fa fa-bullseye"></i>@lang('lang_v1.order')</a>
                </li>
                <li class="{{ $request->segment(1) == 'customer-order-list' ? 'active' : '' }}"><a
                          href="{{action('CustomerOrderController@getOrders')}}"><i class="fa fa-list-ol"></i>@lang('lang_v1.list_order')</a>
                </li>
        ...
        <!-- end only customer accessable pages -->
          ...
          @if($enable_cheque_writing == 1)
            ...
            <!--  Cheque Writing Module pages -->
              <li
                      class="treeview {{  in_array( $request->segment(1), ['cheque-templates', 'cheque-write', 'stamps', 'cheque-numbers']) ? 'active active-sub' : '' }}"
                      id="" style="background: brown">
                <a href="#" id=""><i class="fa fa-book"></i> <span>@lang('cheque.cheque_writing_module')</span>
                  <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
                </a>
                <ul class="treeview-menu">
                  ...
                  <li class="{{ $request->segment(1) == 'cheque-templates'  && $request->segment(2) == '' ? 'active' : '' }}"><a
                            href="{{action('Chequer\ChequeTemplateController@index')}}"><i class="fa fa-book  "></i>@lang('cheque.templates')</a>
                  </li>

                  <li class="{{ $request->segment(1) == 'cheque-templates' && $request->segment(2) == 'create' ? 'active' : '' }}"><a
                            href="{{action('Chequer\ChequeTemplateController@create')}}"><i class="fa fa-plus  "></i>@lang('cheque.add_new_templates')</a>
                  </li>

                  <li class="{{ $request->segment(1) == 'cheque-write' && $request->segment(2) == 'create' ? 'active' : '' }}"><a
                            href="{{action('Chequer\ChequeWriteController@create')}}"><i class="fa fa-pencil-square-o"></i>@lang('cheque.write_cheque')</a>
                  </li>

                  <li class="{{ $request->segment(1) == 'stamps' && $request->segment(2) == '' ? 'active' : '' }}"><a
                            href="{{action('Chequer\ChequerStampController@index')}}"><i class="fa fa-gavel"></i>@lang('cheque.manage_stamps')</a>
                  </li>

                  <li class="{{ $request->segment(1) == 'cheque-numbers' && $request->segment(2) == '' ? 'active' : '' }}"><a
                            href="{{action('Chequer\ChequeNumberController@index')}}"><i class="fa fa-list-ol"></i>@lang('cheque.cheque_number_list')</a>
                  </li>
