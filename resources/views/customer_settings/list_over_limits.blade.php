...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @slot('tool')
            @can('customer_settings.create')
            <div class="box-tools">
                <button type="button" class="btn btn-primary btn-modal pull-right" id="add_customer_settings_btn"
                    data-href="{{action('CustomerSettingsController@create')}}"
                    data-container=".customer_settings_model">
                    <i class="fa fa-plus"></i> @lang( 'lang_v1.add' )</button>
            </div>
            @endcan
            @endslot
                        ...
                        <table class="table table-striped table-bordered" id="customer_settings_table" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang( 'lang_v1.message_id' )</th>
                                    <th>@lang( 'lang_v1.message_count' )</th>
                                </tr>
                            </thead>
                            <tbody>
