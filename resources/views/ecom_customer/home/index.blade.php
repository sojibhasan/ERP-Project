...
<section class="content-header">
    <h1>{{ __('home.welcome_message', ['name' => Auth::user()->first_name]) }}
    </h1>
</section>
<!-- Main content -->
<section class="content no-print">
    ...
    <div class="row">
        <div class="col-sm-12">
		  @component('components.widget', ['class' => 'box-primary', 'title' => __('customer.purchases_last_30_days')])
		  {!! $pruchase_chart_1->container() !!}
          @endcomponent
        </div>
    </div>
