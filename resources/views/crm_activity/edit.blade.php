<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        {!! Form::open(['url' => action('CRMActivityController@update', $crm_activity->id), 'method' => 'put']) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('name',  $crm_activity->name, ['class' => 'form-control input_number', 'required',
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::email('email',  $crm_activity->email, ['class' => 'form-control','placeholder' =>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('mobile',  $crm_activity->mobile, ['class' => 'form-control input_number', 'required',
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('alternate_number',  $crm_activity->alternate_number, ['class' => 'form-control input_number',
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('landline',  $crm_activity->landline, ['class' => 'form-control input_number', 'placeholder' =>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('city',  $crm_activity->city, ['class' => 'form-control', 'placeholder' =>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('district',  $crm_activity->district, ['class' => 'form-control', 'placeholder' =>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('time_connected',  $crm_activity->time_connected, ['class' => 'form-control',
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('note',  $crm_activity_details->note, ['class' => 'form-control', 'rows' => '4',
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('add_in_customer_page', ['0' => 'No', '1' => 'Yes'] , $crm_activity->add_in_customer_page, ['class' =>
                        'form-control',
...
<script>
    $('#date').datepicker('setDate', "{{\Carbon::parse($crm_activity->date)->format('m-d-Y')}}");
    $('#next_follow_up_date').datetimepicker();
    $('#next_follow_up_date').data("DateTimePicker").date("{{\Carbon::parse($crm_activity_details->next_follow_up_date)->format('m-d-Y H:i:s A')}}")
