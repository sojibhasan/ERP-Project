...
<section class="content-header">
  <a id="" href="{{url('purchases')}}" class="btn btn-danger pull-right btn-flat">@lang('lang_v1.back')</a>
...
<section class="content">
  ...
  {!! Form::open(['url' => action('PurchaseController@update' , [$purchase->id] ), 'method' => 'PUT', 'id' =>
  ...
  <div class="row">
    <div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
      <div class="form-group">
        ...
        {!! Form::text('invoice_no', !empty($purchase->invoice_no) ? $purchase->invoice_no : 1, ['class' =>
        'form-control',
        'readonly'] ); !!}
      </div>
    </div>
    ...
    <div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          ['class' => 'form-control', 'placeholder' => __('messages.please_select') , 'required', 'id' =>
          'supplier_id']); !!}
    ...
    <div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          {!! Form::text('transaction_date', @format_datetime($purchase->transaction_date), ['class' => 'form-control',
          'readonly', 'required']); !!}
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-3 @if(!empty($default_purchase_status)) hide @endif">
      <div class="form-group">
        ...
        {!! Form::select('status', $orderStatuses, $purchase->status, ['class' => 'form-control select2', 'placeholder'
    ...
    <div class="col-sm-3">
      <div class="form-group">
        ...
        {!! Form::select('location_id', $business_locations, $purchase->location_id, ['class' => 'form-control select2',
        'placeholder' => __('messages.please_select'), 'disabled']); !!}
      </div>
    </div>
    ...
    <div class="col-sm-3 @if(!$currency_details->purchase_in_diff_currency) hide @endif">
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          {!! Form::number('exchange_rate', $purchase->exchange_rate, ['class' => 'form-control', 'required', 'step' =>
          0.001]); !!}
        </div>
    ...
    <div class="col-md-3">
      <div class="form-group">
        <div class="multi-input">
          ...
          <br />
          {!! Form::number('pay_term_number', $purchase->pay_term_number, ['class' => 'form-control width-40 pull-left',
          ...
          <tr>
            ...
            <td class="col-md-5 text-left">
              ...
              <input type="hidden" id="total_subtotal_input"
                value="{{$purchase->total_before_tax/$purchase->exchange_rate}}" name="total_before_tax">
            </td>
          </tr>
        </table>
      </div>
        ...
        <tr>
          ...
          <td class="col-md-3">
            <div class="form-group">
              ...
              number_format($purchase->discount_amount/$purchase->exchange_rate, $currency_precision,
              $currency_details->decimal_separator, $currency_details->thousand_separator)
              :
              number_format($purchase->discount_amount, $currency_precision, $currency_details->decimal_separator,
          ...
          <td>
            <div class="form-group">
              ...
              <select name="tax_id" id="tax_id" class="form-control select2" placeholder="'Please Select'">
                ...
                <option value="{{ $tax->id }}" @if($purchase->tax_id == $tax->id) {{'selected'}} @endif
        ...
        <tr>
          ...
          <td>
            <div class="form-group">
              ...
              {!! Form::text('shipping_charges', number_format($purchase->shipping_charges/$purchase->exchange_rate,
        ...
        <tr>
          <td colspan="4">
            <div class="form-group">
              ...
              {!! Form::textarea('additional_notes', $purchase->additional_notes, ['class' => 'form-control', 'rows' =>
              3]); !!}
            </div>
          </td>
        </tr>
  ...
  <div class="box-body payment_row"  data-row_id="0">
    <div id="payment_rows_div">
      ...
      @include('purchase.partials.payment_row_edit', ['row_index' => $j, 'payment' => $pl, 'removable' =>true ])
      @php
        $j++;
      @endphp
      @endforeach
      @else
      @include('purchase.partials.payment_row_edit', ['row_index' => 0, 'removable' =>true])
      @endif
    </div>
    <hr>
