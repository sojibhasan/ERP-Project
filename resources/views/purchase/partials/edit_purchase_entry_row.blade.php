    ...
    <table class="table table-condensed table-bordered table-th-green text-center table-striped"
        ...
        <thead>
            <tr>
                ...
                @if ($enable_free_qty)
                <th style="width: 70px;">@lang( 'purchase.free_qty' )</th>
                @endif
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    $purchase_line->pp_without_discount/$purchase->exchange_rate, ['class' => 'form-control input-sm
                ...
                <td>
                    ...
                    $purchase_line->purchase_price/$purchase->exchange_rate, ['class' => 'form-control input-sm
                    purchase_unit_cost input_number', 'required']); !!}
                    {!! Form::hidden('purchases[' . $loop->index . '][purchase_price]',
                    $purchase_line->purchase_price/$purchase->exchange_rate, ['class' => 'pp_exc_tax', 'required']); !!}
                </td>
                <td class="{{$hide_tax}}">
