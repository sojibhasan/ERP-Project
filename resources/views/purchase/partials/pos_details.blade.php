					...
					<tbody>
								...
								<div class="{{$col}} col-xs-6 d-inline-table">
									...
									<span class="@if($pos_settings['disable_order_tax'] != 0) hide @endif">
										...
										<i class="fa fa-pencil-square-o cursor-pointer"
											title="@lang('sale.edit_order_tax')" aria-hidden="true" data-toggle="modal"
						...
						<tr>
							<td>
								...
								@endif
								<div class="col-sm-3 col-xs-12 col-2px-padding @if(!array_key_exists('card', $payment_types)) hide @endif">
									<button type="button"
								...
								<div class="col-sm-3 col-xs-12 col-2px-padding">
									...
									<button type="button" style="height: 72px;"
										...
										title="@lang('lang_v1.tooltip_credit_purchase')">
										<div class="text-center" style="font-size: 15px;">
											<i class="fa fa-check" aria-hidden="true"></i>
											<b>@lang('lang_v1.credit_purchase')</b>
										</div>
									</button>
								</div>
								{{-- <div class="col-sm-3 col-xs-12 col-2px-padding">
									<button type="button" style="height: 72px;"
										class="btn bg-orange btn-block btn-flat no-print pos-express-finalize"
								...
								<div
									class=" col-sm-3 col-xs-12 col-2px-padding  @if(!array_key_exists('cash', $payment_types)) hide @endif">
									<button type="button"
...
$transaction->rp_redeemed_amount, 'max_available' => !empty($redeem_details['points']) ? $redeem_details['points'] : 0])
@else
