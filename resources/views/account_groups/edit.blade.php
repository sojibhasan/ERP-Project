<div class="modal-dialog" role="document">
  ...
  {!! Form::open(['url' => action('AccountGroupController@update', $account_group->id), 'method' => 'put', 'id' => 'account_group_form' ]) !!}
  ...
  <div class="modal-body">
    <div class="form-group">
      ...
      @if ($account_group->name == "Sales Income Group" || $account_group->name == "COGS Account Group" || $account_group->name == "Inventory")
      {!! Form::text('name', $account_group->name, ['class' => 'form-control', 'required', 'placeholder' => __( 'lang_v1.name' ), 'id' => 'account_group_name_group', 'readonly']);!!}
      @else
