...
<section class="content no-print">
	...
	<div class="row">
		<div class="left_div  col-md-6 col-sm-12">
			...
			@endslot
			{!! Form::open(['url' => action('PurchasePosController@store'), 'method' => 'post', 'id' =>
			...
			'readonly', 'required']); !!}
			{!! Form::hidden('invoice_no', !empty($purchase_no) ? $purchase_no : 1, ['class' => 'form-control',
			...
			<div class="box-body">
						...
						<div class="form-group" style="width: 100% !important">
							<div class="input-group">
								...
								<input type="hidden" id="default_supplier_id"
									value="{{!empty($default_supplier['id']) ? $default_supplier['id'] : null}}">
								<input type="hidden" id="default_supplier_name"
									value="{{ !empty($default_supplier['name']) ? $default_supplier['name'] : null}}">
				...
				@include('purchase_pos.partials.suspend_note_modal')
...
function getInvoice() {
	$.ajax({
		method: 'get',
		url: '{{action("PurchaseController@getInvoiceNo")}}',
