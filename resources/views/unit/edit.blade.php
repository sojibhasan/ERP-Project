    ...
    <div class="modal-body">
      <div class="row">
        <div class="form-group col-sm-12">
          ...
          {!! Form::text('actual_name', $unit->actual_name, ['class' => 'form-control', 'required', 'placeholder' => __(
          'unit.name' )]); !!}
        </div>

        <div class="form-group col-sm-12">
          {!! Form::label('short_name', __( 'unit.short_name' ) . ':*') !!}
          {!! Form::text('short_name', $unit->short_name, ['class' => 'form-control', 'placeholder' => __(
          'unit.short_name' ), 'required']); !!}
        </div>
          ...
          <div class="form-group">
            <div class="checkbox">
              <label>
                ...
                'data-toggle_id' => 'base_unit_div' ]); !!} @lang( 'lang_v1.add_as_multiple_of_base_unit' )
          ...
          <table class="table">
            <tr>
              ...
              <td style="vertical-align: middle;">
                ...
                'placeholder' => __( 'lang_v1.times_base_unit' )]); !!}</td>
              <td style="vertical-align: middle;">
