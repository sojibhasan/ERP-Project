<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h3 class="modal-title">@lang( 'cash_register.register_details' ) ( {{ \Carbon::createFromFormat('Y-m-d H:i:s', $register_details->open_time)->format('jS M, Y h:i A') }} @if(!empty($register_details->closed_at))- {{ \Carbon::createFromFormat('Y-m-d H:i:s', $register_details->closed_at)->format('jS M, Y h:i A') }}@endif)</h3>
    </div>
