@extends('layouts.app')
@section('title', __('lang_v1.store_transfers'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1>@lang('lang_v1.store_transfers')
    </h1>
</section>
...
<section class="content no-print">
    ...
    @endcomponent
    @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.all_store_transfers')])
        @slot('tool')
            <div class="box-tools">
