@extends('layouts.app')
@section('title', __( 'lang_v1.list_order'))
@section('content')

<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1>@lang('lang_v1.list_order')
        <small></small>
    </h1>
</section>
...
<section class="content no-print">
    @component('components.widget', ['class' => 'box-primary'])
        @slot('tool')
            <div class="box-tools">
                <a class="btn btn-block btn-primary" href="{{action('CustomerOrderController@create')}}">
...
$(document).ready( function(){
    sell_table = $('#sell_table').DataTable({
        ...
        serverSide: true,
        aaSorting: [[0, 'desc']],
        ajax: '/customer-order-list?is_quotation=1',
        columnDefs: [ {
            "targets": 4,
            "orderable": false,
            "searchable": false
