    ...
    $(document).ready(function(){
        ...
        $('#daterange-btn').daterangepicker(
            ...
            function (start, end) {
                ...
                sell_return_table.ajax.url( '/customer-sell-return?start_date=' + start.format('YYYY-MM-DD') + '&end_date=' + end.format('YYYY-MM-DD') ).load();
            }
        );
        $('#daterange-btn').on('cancel.daterangepicker', function(ev, picker) {
            sell_return_table.ajax.url( '/customer-sell-return').load();
