...
<section class="content no-print">
	...
	{!! Form::open(['url' => action('CustomerOrderController@store'), 'method' => 'post', 'id' => 'add_sell_form' ]) !!}
	<div class="row">
			...
			<div class="col-sm-4 hide">
				<div class="form-group">
					...
					<div class="input-group">
                        ...
                        @php
                            $contact = App\Contact::where('contact_id', auth()->user()->username)->first();
                        @endphp
						<input type="hidden" id="default_customer_id" value="{{ $contact->id}}">
						<input type="hidden" id="default_customer_name" value="{{  $contact->name }}">
