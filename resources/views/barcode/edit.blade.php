  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('label_font_size', __('barcode.label_font_size')) !!}
            <div class="input-group">
              <span class="input-group-addon">
                <i class="fa fa-font" aria-hidden="true"></i>
              </span>
              {!! Form::number('label_font_size', $barcode->label_font_size, ['class' => 'form-control',
              'placeholder' => __('barcode.label_font_size'), 'min' => 1, 'required']); !!}
            </div>
          </div>
        </div>
        <div class="clearfix"></div>
