    ...
    <div class="modal-body">
      ...
      <div class="row">
          ...
          <div class="col-xs-6">
            ...
            <b>@lang('lang_v1.bank_name'):</b> {{$single_payment_line->payment_account->name ?? ''}} <br>
          ...
          <div class="col-xs-6">
            ...
            <b>@lang('lang_v1.recur_interval'):</b> {{$transaction->recur_interval}}{{ucfirst($transaction->recur_interval_type)}}<br>
