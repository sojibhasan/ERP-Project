        ...
        <div class="col-md-12">
            <div class="col-md-3">
                ...
                <div class="input-group">
                    ...
                    'placeholder' => __('lang_v1.payment_ref_no'),'disabled'=>true, 'style' => 'width: 100%;']); !!}
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    __('petro::lang.balance'), 'style' => 'width: 100%;']); !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
            ...
            <div class="payment_data_row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        !!}
                        {!! Form::select('customer_payment_bulk_payment_method',['cash' => 'Cash','card' => 'Card','cheque'=>'Cheque'], null, ['class' => 'form-control
