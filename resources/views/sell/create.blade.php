...
<section class="content no-print">
		...
		<div class="col-sm-3">
			<div class="form-group">
				<div class="input-group">
					...
					{!! Form::select('select_store_id', $stores, null, ['class' => 'form-control
					input-sm',
					...
					<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
						<thead>
							<tr>
								...
								<th class="price_later_td hide">@lang('lang_v1.purchase_price')</th>
								<th>@lang('sale.tax')</th>
								<th class="text-center">
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<button type="button" value="save_and_print" style="margin-right: 10px;"
