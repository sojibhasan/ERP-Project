...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            'sales_representative_filter_form' ]) !!}
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('sr_id', __('report.sale_commission_agent') . ':') !!}
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('sr_business_id', $business_locations, null, ['class' => 'form-control select2',
                    'style' => 'width:100%']); !!}
                </div>
            </div>
