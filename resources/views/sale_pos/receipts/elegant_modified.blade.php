...
<div class="row invoice-info">
	...
	<div class="col-xs-12  text-{{$header_align}} color-555">
	...
	<div class="col-xs-12 text-center" style="font-size: {{$h_font_size}}px !important;">
...
<div class="row color-555" style="font-size: {{$font_size}}px !important;">
	<div class="col-xs-12">
		<br/>
		<table class="table table-bordered table-no-top-cell-border">
			...
			<tbody>
				@foreach($receipt_details->lines as $line)
					<tr>
						<td class="text-center" style=" font-size: {{$font_size}}px !important;">
							{{$loop->iteration}}
						</td>
...
<div class="row invoice-info color-555" style="page-break-inside: avoid !important" style="font-size: {{$f_font_size}}px !important;">
