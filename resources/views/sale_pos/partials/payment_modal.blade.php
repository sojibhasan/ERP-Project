	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
						...
						<div class="row">
							<div id="payment_rows_div">
								...
								@foreach($payment_lines as $payment_line)
									...
									@include('sale_pos.partials.payment_row', ['removable' => !$loop->first, 'row_index' => $loop->index, 'payment_line' => $payment_line, 'payment' => !empty($temp_data->payment)?$temp_data->payment[$loop->index]:[]])
								@endforeach
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									{!! Form::textarea('sale_note',!empty($temp_data->sale_note)?$temp_data->sale_note: (!empty($transaction)? $transaction->additional_notes:null), ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('sale.sell_note')]); !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									!empty($temp_data->staff_note)?$temp_data->staff_note:(!empty($transaction)? $transaction->staff_note:null), ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('sale.staff_note')]); !!}
								</div>
							</div>
						</div>
					</div>
						...
						<div class="box box-solid bg-orange">
				            <div class="box-body">
				            	...
				            	<div class="col-md-12">
				            		<hr>
				            		<strong>
				            			@lang('sale.customer_wallet'):
				            		</strong>
				            		<br/>
				            		<span class="lead text-bold customer_wallet">0</span>
				            	</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-danger" id="add_to_customer_wallet">@lang('sale.add_to_customer_wallet')</button>
