		...
		<div class="modal-body">
			<div class="row">
				...
				@forelse($sales as $sale)
					@if($sale->is_suspend)
						<div class="col-xs-6 col-sm-3 sale-{{$sale->id}}">
							<div class="small-box bg-yellow">
							 ...
							 <a href="{{action('SellPosController@destroy', [$sale->id])}}" class="delete-sale-suspend btn" style=" background: brown; width: 100%; color: white;">Cancel</a>
				         </div>
				        @php
				         	$c++;
				        @endphp
