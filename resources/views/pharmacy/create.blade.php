@extends('layouts.app')
@section('title', __('patient.pharmacy'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
  <h1>@lang('patient.pharmacy')</h1>
</section>
<style>
  label {
...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      @include('pharmacy.partials.add_pharmacy_form')
      @endcomponent
    ...
    <div class="modal-dialog" role="document" style="width: 70%;">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <h3 class="form-header">@lang('patient.pharmacy_register')</h3>
          {!! Form::open(['url' => route('pharmacy_register'), 'method' => 'post', 'id' =>
          'hospital_register_form','files' => true ]) !!}
          @include('business.partials.register_form_hospital',['business' => 'Pharmacy Name'])
