...
<section class="content">
    {!! Form::open(['url' => action('ImportPurchasesController@import'), 'method' => 'post', 'id' => 'import_sale_form']) !!}
...
<script type="text/javascript">
    $(document).on('submit', 'form#import_sale_form', function(){
        ...
        if (import_fields.indexOf('supplier_phone_number') == -1 && import_fields.indexOf('supplier_email') == -1) {
            alert("{{__('lang_v1.supplier_email_or_phone_required')}}");
            return false;
        }
