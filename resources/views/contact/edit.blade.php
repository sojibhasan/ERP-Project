  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div
          class="col-md-4  @if($contact->type=='customer' && !array_key_exists('customer_tax_number', $contact_fields)) hide @endif @if($contact->type=='supplier' && !array_key_exists('supplier_tax_number', $contact_fields)) hide @endif">
          <div class="form-group">
        ...
        <div
          class="col-md-4  @if($contact->type=='customer' && !array_key_exists('customer_pay_term', $contact_fields)) hide @endif @if($contact->type=='supplier' && !array_key_exists('supplier_pay_term', $contact_fields)) hide @endif">
          <div class="form-group">
        ...
        <div
          class="col-md-4 customer_fields  @if($contact->type=='customer' && !array_key_exists('customer_customer_group', $contact_fields)) hide backend_hide @endif">
          <div class="form-group">
        ...
        <div
          class="col-md-4 supplier_fields  @if($contact->type =='supplier' && !array_key_exists('supplier_supplier_group', $contact_fields)) hide backend_hide @endif">
          <div class="form-group">
        ...
        <div
          class="col-md-4 customer_fields  @if($contact->type=='customer' && !array_key_exists('customer_password', $contact_fields)) hide backend_hide @endif">
          <div class="form-group">
        ...
        <div
          class="col-md-4 customer_fields  @if($contact->type=='customer' && !array_key_exists('customer_confirm_password', $contact_fields)) hide backend_hide @endif">
          <div class="form-group">
        ...
        <div
          class="col-md-3  @if($contact->type=='customer' && !array_key_exists('customer_email', $contact_fields)) hide @endif @if($contact->type=='supplier' && !array_key_exists('supplier_email', $contact_fields)) hide @endif">
          <div class="form-group">
        ...
        <div
          class="col-md-3  @if($contact->type=='customer' && !array_key_exists('customer_mobile', $contact_fields)) hide @endif @if($contact->type=='supplier' && !array_key_exists('supplier_mobile', $contact_fields)) hide @endif">
          <div class="form-group">
        ...
        <div
          class="col-md-3  @if($contact->type=='customer' && !array_key_exists('customer_alternate_contact_number', $contact_fields)) hide @endif @if($contact->type=='supplier' && !array_key_exists('supplier_alternate_contact_number', $contact_fields)) hide @endif">
          <div class="form-group">
        ...
        <div
          class="col-md-3  @if($contact->type=='customer' && !array_key_exists('customer_landline', $contact_fields)) hide @endif @if($contact->type=='supplier' && !array_key_exists('supplier_landline', $contact_fields)) hide @endif">
          <div class="form-group">
        ...
        <div
          class="col-md-3  @if($contact->type=='customer' && !array_key_exists('customer_city', $contact_fields)) hide @endif @if($contact->type=='supplier' && !array_key_exists('supplier_city', $contact_fields)) hide @endif">
          <div class="form-group">
        ...
        <div
          class="col-md-3  @if($contact->type=='customer' && !array_key_exists('customer_state', $contact_fields)) hide @endif @if($contact->type=='supplier' && !array_key_exists('supplier_state', $contact_fields)) hide @endif">
          <div class="form-group">
        ...
        <div
          class="col-md-3  @if($contact->type=='customer' && !array_key_exists('customer_country', $contact_fields)) hide @endif @if($contact->type=='supplier' && !array_key_exists('supplier_country', $contact_fields)) hide @endif">
          <div class="form-group">
        ...
        <div
          class="col-md-3  @if($contact->type=='customer' && !array_key_exists('customer_landmark', $contact_fields)) hide @endif @if($contact->type=='supplier' && !array_key_exists('supplier_landmark', $contact_fields)) hide @endif">
          <div class="form-group">
...
<script>
  ...
  @else
  $('#transaction_date_contact').datepicker('setDate', new Date());
  @endif
